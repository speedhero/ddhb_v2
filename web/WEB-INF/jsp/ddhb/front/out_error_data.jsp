...
<%-- 新增一个用于提交简历之后,显示反馈信息 --%>
<c:if test="${submitResume != null}">
<div style="padding:20px;line-height:22px;" >
尊敬的<font color="red">${recruitCandidate.name}</font>${recruitCandidate.gender == 1 ? "女士":"男士" }:<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;经过您的努力，已成功把简历<br/>投放到华邦服务器上啦，我们将尽<br/>快与您联系。<br/>
祝您拥有美好的每一天！
</div></c:if>
