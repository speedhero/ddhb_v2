...
<div class="cp_rt">
        	<div class="licn"><a onclick='window.location.href="${globalUrl}welcome.show?actionMethod=welcome"'>首页</a>&nbsp;>&nbsp;个人中心&nbsp;>&nbsp;问答管理</div>
            <div class="gr_xxi">您好，你目前提出了<b><c:out value="${anCount + qCount}"></c:out></b>个问题，其已解答<b>${anCount }</b>条，未解答<b>${qCount }</b>个。</div>
			<div class="que_is"><ul><li class="dy" id="resoved">已解决</li>
			<li id="unresoved">未解决</li></ul></div>
                ...
                <div class="gr_nlb">
                	<div class="gr_nrb">
                        <ul>
                            ...
                            <li class="li_2">
								<a style="cursor: pointer;" onclick='window.location.href="${globalUrl}broker.show?actionMethod=initQuestionDetail&questionId=${question.erpId }&typeId=${question.questionType.parentType.erpId }&subTypeId=${question.questionType.erpId }"'>${question.title}</a>
							</li>
                            <li class="li_3"><span>类型:</span>
								${question.questionType.parentType.typeName}
							</li>
