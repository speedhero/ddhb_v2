...
<form:form modelAttribute="signupform" id="signupform" action="${globalUrl}houseNew.show?actionMethod=addNewHouseGroupbuy">
	...
	<input type="hidden" name="houseid" value="${houseNew.newhouseNo }">
</form:form>
</div>
