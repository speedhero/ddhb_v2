...
<!--<style type="text/css">
.mainimgdiv { width:250px; height: 226px; float: left; margin-top: 0px; background-image: url("${pictureHost}${houseNew.pictureUrl}"); background-repeat:no-repeat;   /*图像不重复显示*/ }
.xxnr img{ width: auto; height: auto; border: 0 none; }
.disableClickClass{ color: #FFFFFF;cursor:pointer; position: absolute;  right: -8px;top: 245px;  width: 203px;height: 56px;line-height: 46px;font-size: 30px; text-align: center;  background: url(${globalUrl}image/rtfd_2_gray.gif) no-repeat; }


.enableClickClass{
  color: #FFFFFF;cursor:pointer;  position: absolute;  right: -8px;top: 245px;  width: 203px;height: 56px;line-height: 46px;font-size: 30px;text-align: center;  background: url(${globalUrl}image/rtfd_2.gif) no-repeat;
}

#scrollDiv ul li {line-height: 29px;}
</style>-->
...
<div class="Location"><a href="${globalUrl}welcome.show?actionMethod=welcome">首页</a> >
  <a href="${globalUrl}houseNew.show?actionMethod=dimquery" >杭州新盘</a> >
...
<div class="zhxq_t">
  <div class="hou_tit_con">
     <div class="zh_dbt">${houseNew.adv }</div>
  </div>
  <div class="xmdt_pt">
  ...
  <div class="xm_cen_wd">
    ...
    <!--
    <p>
                  已有<b>${HouseNewEntrant }</b>人报名<br>剩余时间：
    ...
    <p>总价：<b>${houseNew.minPrice }</b>万起</p>
...
<div class="zongji">
  ...
  <div class="zjs">-->
   ...
   <!--  <div class="zjs_k" style="padding-left: 50px;">
      <p>楼盘总计：</p>
      <b>${houseCount+houseCountEnd }</b>
    </div>
  </div>
  <div class="r_tels">
    <div id="scrollDiv" style="overflow: hidden; max-height: 235px;">
    <ul style="height:50%">
...
<div class="fzxx_detail">
   ...
   <div class="ys_ewm">
     <div class="ewm_pt"><img src="${globalUrl}houseNew.show?actionMethod=drawcode&id=${houseNew.id}" alt=""/></div>
     <!--<div class="ewm_a"><a onclick="copyUrl();">复制链接地址</a><div class="bdsharebuttonbox" ><a style="background-image:null;padding:0;" class="bds_more" data-cmd="more">分享</a></div></div>-->
   </div>
...
<div class="zj_ls_w">
  <div class="zj_ls_detail">
      <!--<div class="lp_ewm">
        <div class="loup"><b>楼盘名称：</b>${houseNew.buildingName}<br></div>
      </div>-->
      ...
      <div class="ys_xxnr">
          ...
          <div class="xxnr">${houseNew.facilityName}</div>
      </div>
      <div class="clear"></div>
  </div>
</div>
