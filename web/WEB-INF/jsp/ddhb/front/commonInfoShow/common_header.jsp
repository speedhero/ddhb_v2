...
<div id="t_nav">
	<div class="nav_con">
		<div class="logo logoPc" style="cursor: pointer;">
			<a href="${globalUrl}"><img src="${pictureHost}${homeLogoPc}"
				title="${otherpageHover}" /></a>
		</div>
		<div class="logo logoPad" style="cursor: pointer;">
			<a href="${globalUrl}"><img src="${pictureHost}${homeLogoPad}"
				title="${otherpageHover}" /></a>
		</div>
		<div class="logo logoMb" style="cursor: pointer;">
			<a href="${globalUrl}"><img src="${pictureHost}${homeLogoMb}"
				title="${otherpageHover}" /></a>
		</div>
		<div class="dl_zc"
			<c:if test="${LoginMember != null }"> style="display:none;" </c:if>>
			<a onclick="loginBox();">登录</a> <a onclick="registerBox();">注册</a>
		</div>
		<div class="dl_zc_h"
			<c:if test="${LoginMember == null}"> style="display:none;" </c:if>>
			<a href="#" class="dl_name"
				style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><c:out
					value="${LoginMember.accName }"></c:out></a>
			<div class="dlh_wd">
		...
		<div class="nav">
			<ul>
				...
				<li class="nav_a5" style="<c:if test="${backType == 5 }">background-color:#F79200;</c:if>"><a href="${globalUrl}xinfang">新房</a></li>
				<li class="nav_a4" style="<c:if test="${backType == 4 }">background-color:#F79200;</c:if>"><a href="${globalUrl}xiaoqu">小区</a></li>
		...
		<div id="searchBox">
			<div class="lmtop_sc">
				<div class="sc_an"><a onclick="$('#headScanPadPhone').show();"></a></div>
				<div class="sc_bd" id="headScanPadPhone" style="display: none;">
					<div class="jiao"></div>
					<div class="bd_an"><input id="textPhonePad" name="textfield" type="text" /><a id="searchBtnPad">搜索</a></div>
				</div>
			</div>
			<div class="lmtop_sc">
