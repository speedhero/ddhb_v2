  ...
  <div id="compareDiv" class="duibi" style="display: none;">
    ...
    <div id="compareContentContainer" class="db_ls"
      ...
      <ul id="compareContent">
        ...
        <li class="nob"><a id="showCompare" href="javascript:void(0);" onclick="startCompare('<c:if test="${showCompare == 'S'}">${globalUrl}houseSecond.show?actionMethod=houseSecondCompare</c:if><c:if test="${showCompare == 'R'}">${globalUrl}rent.show?actionMethod=houseRentCompare</c:if><c:if test="${showCompare == 'C'}">${globalUrl}community.show?actionMethod=communityCompare</c:if>')">开始对比</a>
        <p>
