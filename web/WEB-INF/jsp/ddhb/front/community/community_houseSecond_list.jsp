...
<div id="list_list" style="display:none;">
	...
	<div class="wd_ls">
		<ul>
			...
			<li>
					<div class="bianh" onclick="window.open('${globalUrl}/houseSecond.show?actionMethod=houseSecondDetail&houseNo=${house.houseNo}&brokerId=${(houseAppraise != null) ? houseAppraise.broker.erpId : house.broker.erpId}')"
					...
					<div class="wd_rt">
						...
						<c:if test="${LoginMember == null }">
							<a class="shouc_lik fr" href="javascript:void(0);" collId="${house.collectId}" hosueobjectId="${house.objectId}" 
