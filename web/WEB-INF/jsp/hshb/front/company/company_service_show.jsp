...
<div class="about_main"> 
	...
	<div class="cp_rt">
     	<div class="licn"><a href="${globalUrl}">首页</a>&nbsp;>&nbsp;客户服务</div>
     	<form:form modelAttribute="customerService" id="customerService" action="${globalUrl}company/service">
         <div class="yp_nr yp_nr100" style="border-bottom:0px;">
			...
			<select class="marginleft10" name="serviceTypeId" style="width: 185px;" id="serviceType">
				...
				<c:forEach var="typeItem" items="${typeList}">
					<option value="${typeItem.typeNo}">${typeItem.typeName}</option>
				</c:forEach>
			</select>
                 </div>
             </div>
