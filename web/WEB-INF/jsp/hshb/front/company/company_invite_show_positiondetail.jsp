	...
	postBymyURL(actionUrl, dataString, "POST", "html",
			function(data){
				...
				if(data.indexOf('保存成功') >= 0) {
					alert("信息已提交！");
					window.location.href = "${globalUrl}company/showinvite";
...
$(document).ready(function() {
	...
	$("#file_upload").uploadify({
        ...
        //上传处理程序
        'uploader':'${globalUrl}company/dealResume',
        //允许上传的文件后缀
...
<div class="yc_zzy yc_zzyb">
    ...
    <p>招聘人数：${position.needed } 人　<br>工作地点：${position.workplace }　<br>职位类型：${position.typeName }　<br><fmt:formatDate value="${position.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/></p>
</div>
...
<form:form modelAttribute="recruitCandidate" name="recruitCandidate" action="${globalUrl}company/saveResume" id="recruitCandidate" enctype="multipart/form-data">
           	...
           	<li>
                   ...
                   <div class="input">
                   	<div class="xiala xl_w145 z9">
                       	<select name="yearsofworking" style="width:142px;height:22px" id="yearsofworking">
						 	<option value="" selected="">--请选择--</option>
