...
function doSearch(){
  ...
  $("#errordiv").html("");
  dataString = { cardNo : cardNo, contractNo : contractNo, verifyCode : verifyCode, }
  $.ajax({
    type : "post",
...
function processSuccess(contractObj){
  if (contractObj != null){
     ...
     $("#contractNo").val(contractObj.contractID);
     $("#flowPanel").html("");
...
<div style="height:42px;line-height:38px; clear:both; overflow:hidden;padding-left:12px;color: #575f6e;"><a onclick='window.location.href="${globalUrl}"' style="cursor: pointer;">首页</a>&nbsp;>&nbsp;合同查询</div>
<!--合同查询开始-->
  <div class="ht_left">
