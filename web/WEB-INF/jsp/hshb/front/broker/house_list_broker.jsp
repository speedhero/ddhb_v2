	...
	<ul>
		<c:forEach var="house" items="${houseList}" varStatus="item">
			<li>
				...
				<div class="chengxq" style="width:90px">					
					<a href="${globalUrl}chushou/a_${house.county.erpId}_" target="_blank">${house.county.countyName }</a>
					 -	
					 <a href="${globalUrl}chushou/a_${house.county.erpId}_${house.websiteCbd.websiteId}" target="_blank">
					 ${house.websiteCbd.name }
					 </a>
				</div>
