...
<div id="t_nav">
  ...
  <div class="nav">
  		<ul>
  			<li class="nav_a1" style="<c:if test="${backType == 1 }">background-color:#3FB8B1;</c:if>" onclick="window.location.href='${globalUrl}'"><a href="#">首页</a></li>
           <li class="nav_a2" style="<c:if test="${backType == 2 }">background-color:#3FB8B1;</c:if>" onclick="window.location.href='${globalUrl}chushou" ><a href="#">二手房</a></li>
           <li class="nav_a3" style="<c:if test="${backType == 3 }">background-color:#3FB8B1;</c:if>" onclick="window.location.href='${globalUrl}chuzu" ><a href="#">租赁</a></li>
           <li class="nav_a5" style="<c:if test="${backType == 5 }">background-color:#3FB8B1;</c:if>" onclick="window.location.href='${globalUrl}xinfang"><a href="#">新房</a></li>
			<li class="nav_a4" style="<c:if test="${backType == 4 }">background-color:#3FB8B1;</c:if>" onclick="window.location.href='${globalUrl}xiaoqu"><a href="#">小区</a></li>
