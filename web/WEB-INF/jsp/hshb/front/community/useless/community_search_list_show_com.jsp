...
<div class="communityevery" id="image_list" style="margin-top: 20px; display: none;">
	<div class="xqpc_ls">
           ...
           <c:forEach var="community" items="${pageBean.dataList}">
               <li>
                   <div class="pt" onclick="window.location.href='${globalUrl}community.show?actionMethod=communityDetail&id=${community.erpId}'" style="cursor: pointer;"><img src="${pictureHost }${community.communityUrl }" width="226" height="170"  alt=""/><p>共有 ${community.communityPicCount } 张照片</p></div>
                   <div class="tj_txt">
