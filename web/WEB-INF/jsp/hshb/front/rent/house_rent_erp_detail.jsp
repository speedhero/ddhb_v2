            ...
            <div class="dt_pt">
                ...
                <div class="dt_color">
									<c:forEach items="${house.houseTags}" var="tag">
										...
										<div style="float:left; margin: 0px 8px 10px 0px; padding:2px 11px; font-size: 14px; background-color:${tag.tagColor};color:${tag.fontColor};">
									</c:forEach>
                </div>
            </div>
            <div class="jia_pm">
                	...
                	<div class="d_x">
                    	<ul>
                        	<li>交通<p><c:forEach items="${cStaMapping }" var="cstms">
								${cstms.subwayStation.stationName },
							</c:forEach>
