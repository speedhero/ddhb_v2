...
<form:form modelAttribute="entrustSalehouse" name="entrustSalehouse" action="${globalUrl}consignment.show?actionMethod=addtoSale" id="entrustSalehouse">
<div class="wt_con">
	<h3>卖房信息</h3>
    <div class="wt_tb">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right" valign="top" class="td_1"><div class="td_1">小区名称：</div></td>
        <td>
        	<div class="fywz">
            	<ul>
                	<li><input id="textAuto" class="ipt_mc" name="communityName" type="text" value="请输入小区名称..." onfocus='if(value=="请输入小区名称...") {value ="";$(this).css({"color":"#333"})};' onblur='if(value==""){value="请输入小区名称...";$(this).css({"color":"#CCCCCC"})};' style="color:#CCCCCC;!important" class="txt_w490"></li>
     ...
     <%--  <tr>
        ...
        <td class="hxyq">
            ...
            <div class="xiala xl_w64">
                <a href="#" class="a">1</a>
                <div class="xlnr"><a href="#">1990</a><a href="#">1990</a><a href="#">1990</a><a href="#">1990</a><a href="#">1990</a><a href="#">1990</a></div>
            </div>
            <span>卫</span>
            </div> -->
        </td>
      ...
      <tr>
        <td align="right" valign="top" class="td_1"><div class="td_1">您的报价：</div></td>
        <td class="jiawei">
        	<input id="baojia" name="price" type="text" value="" onfocus='if(value=="0") {value =""}' onblur='if(value==""){value="0"}'><span>万元</span>
        </td>
      </tr>
      --%>
       <tr>
      ...
      <tr>
        <td align="right" valign="top" class="td_1"><div class="td_1"></div></td>
        <td>
        <div class="tj_an"><a onclick='trimForm("entrustSalehouse");postmyform("entrustSalehouse", "errordiv");'>提 交</a></div>
        </td>
      </tr>
    </table>
    </div>
    ...
    <div class="wt_lxwm">
        <div class="wtlx_ln">
            ...
            <div class="xiala xl_w90">
                <!-- <a href="#" class="a">先生</a>
                <div class="xlnr"><a href="#">先生</a><a href="#">女士</a></div> -->
                <select id="m2s1" name="gender" onchange="setPlatSex();">
           			<c:if test="${platMemberInfo != null }">
           				<option value="0" <c:if test="${platMemberInfo.sex == 0 }">selected</c:if>>先生</option>
           				<option value="1" <c:if test="${platMemberInfo.sex == 1 }">selected</c:if>>女士</option>
        ...
        <div class="wtlx_ln">
			<span>其它联系方式：</span>
			<div class="lx_ipt">
				<input id="otherContect" type="text" value="没有可不填写.." onfocus='if(value=="没有可不填写..") {value ="";$(this).css({"color":"#333"})};' onblur='if(value==""){value="没有可不填写..";$(this).css({"color":"#CCCCCC"})};' style="color:#CCCCCC;!important" name="otherContect">
			</div>
			<div class="clear"></div>
		</div>
