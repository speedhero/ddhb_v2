...
if(kfguin) {
  _Ten_rightDivHtml = '<div id="_Ten_rightDiv" style="position:absolute; top:560px; right:1px; display: none;">';
  ...
  if(type==1 && kf_getCookie('hasshown')==0){
      ...
      welcomeword = kf_processWelcomeword(welcomeword);
  	  ...
  	  //modified by simon 2010-11-23 for <br> show
  	  welcomeword = welcomeword.replace(/<br>/g,'\r\n');
  	  //modified by simon 2010-11-23 end
...
function kf_getPopupDivHtml(kfguin,reference,companyname,welcomeword, wpadomain){
    ...
    temp += '<a onclick="kf_openChatWindow(1,\''+wpadomain+'\',\''+kfguin+'\');return false;" href="#" style="float:right; background-image:url('+urlroot+'btn_2.gif); margin:0; padding:0px; border:0px; height:21px; width:69px;"></a></div>';
...
function kf_getPopup_Ten_rightDivHtml(kfguin,reference, wpadomain){
	...
	temp += '<div style="clear:both;"><a href="#" onclick="kf_openChatWindow(0,\''+wpadomain+'\',\''+kfguin+'\');return false;" style="width:69px; height:21px; background:url('+urlroot+'btn_2.gif); margin:0 0 0 2px; display:block;"></a></div></div>';
