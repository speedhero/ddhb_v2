function prenext(p,gl) {
	//alert(gl);
	if (p == 1) {
		if (gl==0) {
			$(".responsive").slickNext();	
		}else {
			$(".responsive2").slickNext();	
		}
	} else {
		if (gl==0) {
			$(".responsive").slickPrev();	
		}else {
			$(".responsive2").slickPrev();
		}
...
(function(factory) {
			...
			_.defaults = {
				...
				customPaging : function(slider, i) {
					//return '<button type="button">' + (i + 1) + '</button>';
					  return '<div UNSELECTABLE="on" style="color:#22A8A9;font-size:20px;"><span style="display:none;">' + (i + 1) + '</span>●</div>';
				},
				dots : false,
				draggable : true,
				easing : 'linear',
	...
	Slick.prototype.buildDots = function() {
		...
		if (_.options.dots === true && _.slideCount > _.options.slidesToShow) {
			 ...
			 * 
			 * for (i = 0; i <= _.getDotCount(); i += 1) { dotString += '<li>' +
			 * _.options.customPaging.call(this, _, i) + '</li>'; }
			 * 
			 * dotString += '</ul>';
			 */
			//alert(i);
			//alert(_.options);
			//alert(glob);
			dotString = '<div class="tab2leftrightslither"><table style="text-align: center;margin:auto;"><tr><td><img onclick="prenext(0,'+glob+')" src="images/icons/leftnarrow.png" style="display: block;cursor:pointer;" /></td><td unselectable="on">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><ul class="slick-dots">';

			for (i = 0; i <= _.getDotCount(); i += 1) {
				dotString += '<li id="a' + i + '" style="display:block;">' + _.options.customPaging.call(this, _, i) + '</li>';
			}

			dotString += '</ul></td><td unselectable="on">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><img onclick="prenext(1,'+glob+')" src="images/icons/rightnarrow.png" style="display: block;cursor:pointer;" /></td></tr></table></div>';
	...
	Slick.prototype.setDimensions = function() {
		...
		if (_.options.vertical === false) {
			...
			//alert(Math.ceil((_.slideWidth * _.$slideTrack.children('.slick-slide').length)));
			if (_.options.centerMode === true) {
				_.$list.css({
