...
import com.huatek.zip.ZipOutputStream;
...
public class ZipEntry implements ZipConstants, Cloneable {
	...
	private static long dosToJavaTime(long dtime) {
		Date d = new Date((int) ((dtime >> 25 & 127L) + 80L), (int) ((dtime >> 21 & 15L) - 1L), (int) (dtime >> 16 & 31L),
				(int) (dtime >> 11 & 31L), (int) (dtime >> 5 & 63L), (int) (dtime << 1 & 62L));
		return d.getTime();
	}
	...
	private static long javaToDosTime(long time) {
		...
		return year < 1980 ? 2162688L : (long) (year - 1980 << 25 | d.getMonth() + 1 << 21 | d.getDate() << 16
