...
public class Urlset extends BaseEntity {
    ...
    public static Urlset fromHouse(List<Community> commList){
    	Urlset urlset = new Urlset();
    	for(Community comm: commList){
    		TUrl t =  TUrl.fromCommunity(comm);
    		if(t == null){
    			//小区有问题
    			comm.getBaiDuCommuntiy().setState(4);
    			continue;
    		}
    		urlset.getUrl().add(t);
    		comm.getBaiDuCommuntiy().setIsSync(true);
    	}
    	return urlset;
    }    
}
