...
public class TUrl {
    ...
    public static TUrl fromHouse(PartnerBaiduHouseRent house){
    	TUrl url = new TUrl();
    	url.setData(TData.fromHouse(house));
//    	String loc = "http://" + StringUtil.HSHB_DOMAIN + "/baidu/houseRentDel/"+house.getHouseId();
    	//String loc = "http://" + StringUtil.HSHB_DOMAIN + "/baidu/houseRent/" + house.getHouseId();
    	String loc = "http://" + StringUtil.HSHB_DOMAIN + "/chuzu/" + house.getHouseId()+".html";
    	url.setLoc(loc);
    	return url;
    }
}
