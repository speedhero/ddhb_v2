 ...
 *       &lt;sequence&gt;
 *         &lt;element name="RentalInfo" type="{}tRentalInfo"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class TData {
    ...
    @XmlElement(name = "RentalInfo", required = true)
    protected TRentalInfo rentalInfo;
     ...
     *     
     */
    public TRentalInfo getRentalInfo() {
        return rentalInfo;
    }
     ...
     *     
     */
    public void setRentalInfo(TRentalInfo value) {
        this.rentalInfo = value;
    }

    
    public static TData fromHouse(HouseRentHouseExt house){
    	TData data = new TData();
    	TRentalInfo tRentalInfo = TRentalInfo.fromHouse(house);
    	if(tRentalInfo == null)
    		return null;
    	data.setRentalInfo(tRentalInfo);
    	return data;
    }
}
