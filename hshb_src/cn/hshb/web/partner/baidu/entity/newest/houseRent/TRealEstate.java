...
public class TRealEstate extends BaseEntity{
	...
	public static TRealEstate fromHouse(HouseRentHouseExt house){
    	TRealEstate r = new TRealEstate();
    	
//    	if(house.getCommunity() == null){
//    		System.out.println("community is NULL RentHouse:" + house.getHouseId());
//    	}
...
//    	r.setRealestateID("http://"+StringUtil.HSHB_DOMAIN+"/community/communityDetail/"+house.getCommunity().getErpId());
    	if(StringUtil.isNotEmpty(house.getCommunityId()))
    	r.setRealestateID("http://"+StringUtil.HSHB_DOMAIN+"/xiaoqu/"+house.getCommunityId()+".html");
    	else {
    		System.out.println("--------------rent-house.communityId is null");
    		return null;
    	}
    	r.setRealestateName(strToCDATA(house.getCommunityName(), "未知"));
//    	r.setRealestateDistrict(strToCDATA(house.getCommunity().getRegion().getCountyName(), "未知"));
    	...
    	//小区所在的地址
    	//r.setRealestateStreet(strToCDATA(house.getCommunityAddress(),"未知"));
...
//    		cbdName = house.getCommunity().getCbd().getParentCBD().getName();
    	r.setLocalBusiness(strToCDATA(house.getCbdWsiteName(),"未知"));
    	return r;
    }
	...
	public void setRealestateDistrict(String realestateDistrict) {
		this.realestateDistrict = realestateDistrict;
	}
