...
public class TUrl {
    ...
    public static TUrl fromHouse(HouseRentHouseExt house){
    	TUrl url = new TUrl();
    	TData tData = TData.fromHouse(house);
    	if(tData == null)
    		return null;
    	url.setData(tData);
//    	String loc = "http://"+StringUtil.HSHB_DOMAIN+"/baidu/houseRent/"+house.getHourseNo();
    	String loc = "http://" + StringUtil.HSHB_DOMAIN+"/chuzu/"+house.getHouseId()+".html";
//    	if(house.getBroker()!=null){ 
//    		house.getBaiDuHouseRentList().setBrokerErpId(house.getBroker().getErpId());
