...
public class TRentRoom extends BaseEntity{
    ...
    public static TRentRoom fromHouse(HouseRentHouseExt house){
...
//    	h.setRoomOrientation(TRoomOrientation.fromHBValue(house.getOrientations() == null ? null:house.getOrientations().getOrientationName()));
    	h.setRoomOrientation(TRoomOrientation.fromHBValue(StringUtil.isEmpty(house.getOrientationName()) ? null:house.getOrientationName()));
    	//    	h.setRoomArea((int)house.getArea() + "m2");
    	h.setRoomArea((int)(float)house.getArea() + "m2");
