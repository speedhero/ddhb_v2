...
public class THouse extends BaseEntity {
	...
	public static THouse fromHouse(HouseSecond house){
    	if(house.getErpHousePicList()==null || house.getErpHousePicList().size()<1)
    		{
    			System.out.println("The other picture size <0	 secondHouse_id:" + house.getHouseNo());
    			return null;
    		}
    	if(house.getPictureUrl() == null )
    		{
    		System.out.println("The cover image is empty secondHouse_id:" + house.getHouseNo());
    			return null;
    		}
...
//    		return null;
    		}else if(house.getCommunity().getPropertyType() == null){ 
    			h.setHouseType(THouseType.fromHBValue("其他"));
    		}else{
